  ...
  return (
   <div
    ...
    >
      ...
      <a href="https://e.ento.mn"  target="_blank"className="inline-flex items-center justify-center p-1 text-base font-medium text-gray-700 rounded-lg bg-teal-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
