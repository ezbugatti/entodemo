      ...
      <Layout>
        <div className=" container mx-auto pb-20">
          ...
          <div className="  flex justify-between gap-10">
            <div className="w-full items-center bg-gray-50 flex flex-col gap-3 px-3 pt-2">
              <div role="status">
                <svg
                  aria-hidden="true"
                ...
                <span class="sr-only items-center w-full h-full">
                  Түр хүлээнэ үү...
                </span>
              </div>
              <h3 className="select-none cursor-pointer flex justify-between">
                <span className="font-semibold">Түр хүлээнэ үү...</span>
              </h3>
            </div>
          </div>
        </div>
  ...
  if (err)
    return (
      <p className="h-screen flex flex-col justify-center items-center text-2xl">
        <span>{err}</span>
        <Link href="/product" className="text-lg text-gray-500 font-semibold">
          &larr;Refresh page
        </Link>
      </p>
    );
